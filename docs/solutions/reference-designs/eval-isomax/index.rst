...
.. figure:: primary_side.png
    :caption: EVAL-ISOMAX Hardware Components
...
ADI broad market BMS boards such as the :adi:`EVAL-ADBMS6830BMSW` battery stack monitor and the :adi:`EVAL-ADBMS2950-BASIC` pack monitor.
...
possible microcontrollers to be paired are the :adi:`SDP-K1` and :adi:`AD-APARD32690-SL` .
